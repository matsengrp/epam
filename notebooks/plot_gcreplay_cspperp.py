# Plot CSP perplexity for all models on Replay
...
for chain in ['igh','igk']:
    ...
    df = pd.read_csv(f'gcreplay_{chain}_cspperp.csv')
    ...
    plt.gcf().text(0, 0.89, "C", fontsize=40)
    plt.tight_layout()

    outfname = f"{output_dir}/gcreplay_{chain}_cspperp"
