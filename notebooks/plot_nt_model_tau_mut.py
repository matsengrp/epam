...
path_to_opt_bl = "tables/"
path_to_ssp_data = "dataframes/"
output_dir = "plots/"
...
for dsinfo in dataset_list:
    ...
    dstitle = dsinfo[1]
    dsfilename = dsinfo[2]
    dspath = os.path.join(path_to_opt_bl, dsfilename)
    ...
    for model, modelname in zip(model_list, modelname_list):
        ...
        combined_file = os.path.join(path_to_opt_bl, f"{dsname}_{model}_optimized_branch_lengths.csv.gz")
