...
for outdir, child_is_leaf in [('anc',False), ('leaf',True)]:
    
    output_dir = f"testtmp/{outdir}"
    ...
    for dsinfo in dataset_list:
        ...
        for model in model_list:
            ...
            muts_obs_pred_df = get_site_substitutions_df(get_subs_and_preds_from_aaprob(aaprob_path, child_is_leaf), numbering)
            ...
            sitemuts_df = get_site_mutabilities_df(aaprob_path, numbering, child_is_leaf)
            ...
            subacc_df = get_site_subs_acc_df(get_sub_acc_from_aaprob(aaprob_path, 1, child_is_leaf), numbering)
            ...
            csp_df = get_site_csp_df(aaprob_path, numbering, child_is_leaf)
