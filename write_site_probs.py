...
models = ['GCReplaySHM', 'GCReplayOptSHM', 'GCReplayOptSHMDMSSigmoid']
chains = ['igh','igk']

for modelname in models:
    for chain in chains:
        print(modelname, chain)
        aaprob_path = f'output/{chain}/gctrees_2022-06-16_{chain}_pcp_NoBackMuts/{modelname}_{chain}/aaprob.hdf5'
        ...
        output_df.to_csv(f'{modelname}_{chain}_site_sub_probs.csv', index=False)
